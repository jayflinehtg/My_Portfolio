...
<body>
  <div class="main-container">
    <header class="header">
      <h2 class="logo">Jay<span>.dy</span></h2>
      <nav class="navbar">
    ...
    <div class="project-content">
      ...
      <ul>
        ...
        <p>
          ...
          complete it together with my colleagues.
        </p>
        <br />
...
// ---------------------------------------- SCRIPT AUTENTIKASI DENGAN JS--------------------------------
    // Mengambil elemen tombol login dan register
  ...
  // Fungsi untuk menampilkan pop-up autentikasi
  function showAuthPopup(action) {
    Swal.fire({
      ...
      confirmButtonText: action === 'login' ? 'Login' : 'Register',
    ...
    if (result.isConfirmed) {
        // Lakukan sesuatu setelah berhasil login atau register
    console.log(`User ${action} success with username: ${result.value.username}, password: ${result.value.password}`);
